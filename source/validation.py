...
import torch
from utils.jacobian import jacobian_determinant
from model import SpatialTransform
from losses import dice


def validation(range_flow, atlases, atlases_label, valsets, valsets_label, atlas_show,val_show, model, labels, slice=None):
